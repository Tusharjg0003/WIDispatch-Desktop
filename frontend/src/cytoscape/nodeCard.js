...
// (lucide path data, stroked white). Cytoscape draws the rest of the card (dark
...
export const CARD_TYPES = new Set(["plant", "pump", "valve"]);
...
const ICON = {
  ...
  valve: '<path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/>',
};
